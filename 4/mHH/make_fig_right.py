...
v_c_hot = np.genfromtxt('v_c_hot_mHHdclamp.csv', delimiter = ',')
v_c_cold = np.genfromtxt('v_c_cold_mHHdclamp.csv', delimiter = ',')

v_e_hot = np.genfromtxt('v_e_hot_mHHdclamp.csv', delimiter = ',')
v_e_cold = np.genfromtxt('v_e_cold_mHHdclamp.csv', delimiter = ',')

v_g_hot = np.genfromtxt('v_g_hot_mHHdclamp.csv', delimiter = ',')
v_g_cold = np.genfromtxt('v_g_cold_mHHdclamp.csv', delimiter = ',')

v_i_hot = np.genfromtxt('v_i_hot_mHHdclamp.csv', delimiter = ',')
v_i_cold = np.genfromtxt('v_i_cold_mHHdclamp.csv', delimiter = ',')
